			...
			<div class="contacto">
		    	<div class="form-group">
		    		<form action="" class="form">
				     ...
				     <input type="text" class="form-control" id="nombre" placeholder="Nombre" required> <br><br>
				    <label class="etiquetas" for="email">Correo electronico(requerido)</label>
				    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter email" required><br><br>
				    <label class="etiquetas" for="asunto">Asunto</label>
				    <input type="text" class="form-control" id="asunto" required> <br><br>
			    	...
			    	<button type="submit" id="formulario" onclick="pregunta()" class="btn btn-primary">Enviar</button>
			    	</form>
				</div>
		  	</div>
		</div>
